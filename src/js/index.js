(function () {
  /**
   * Assigns interpage navigation links to smooth scroll to section based on hash and section id
   */
  function assignInterpageNavHandlers() {
